...
export default function Hero({ content }: { content: HeroContent }) {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-cream-50">
      ...
      <motion.div style={{ y, opacity }} className="relative mx-auto max-w-7xl px-6 pt-32 pb-28 text-center">
        <motion.p
      ...
      <div className="relative border-t border-cream-200 py-6 overflow-hidden">
        <div className="flex w-max animate-marquee gap-16">
          {[...BRANDS, ...BRANDS].map((brand, i) => (
            <span key={i} className="text-sm font-medium uppercase tracking-[0.2em] text-coffee-500 whitespace-nowrap">
              {brand}
            </span>
          ))}
        </div>
